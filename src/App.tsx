...
<a href="https://drive.google.com/file/d/1PsjNv6gz4CO-5nAqXsforrnhiya0J56V/view?usp=sharing " className="relative group text-gray-300 hover:text-white transition-colors">
  Resume
  <span className="absolute left-0 -bottom-1 h-[2px] w-0 bg-white transition-all duration-300 group-hover:w-full"></span>
</a>
      ...
      <section id="home" className="pt-20 pb-32 bg-gradient-to-br from-black via-zinc-900 to-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
          <div className="text-center">
            ...
            <span className="text-4xl md:text-5xl font-bold text-center text-white leading-tight mb-4 block ">
            <Typewriter
  ...
  <div className="flex justify-center gap-4">
    ...
    <a href="/resume.pdf" className="text-2xl btn-secondary text-white" download>Download Resume</a>
  </div>
</div>
            </form>
          </div>
